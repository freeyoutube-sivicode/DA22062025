...
const ProductDetail: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        ...
        console.error('Error fetching product detail:', err); // Log the error
      ...
      return (
          <div className="container mx-auto px-4 py-8">
              <Card style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
                  <Paragraph>Không có ảnh sản phẩm để hiển thị hoặc ảnh bị lỗi định dạng.</Paragraph>
              </Card>
          </div>
      );
  }
  ...
  // Ensure currentImageIndex is valid after filtering images
   const displayImageIndex = currentImageIndex < allImages.length ? currentImageIndex : 0;
