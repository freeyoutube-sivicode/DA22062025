      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mb-4">
          ...
          {formData.Main_Image && typeof formData.Main_Image === 'string' && (
             <p className="text-gray-600 text-sm mt-1">Current: {formData.Main_Image}</p>
          )}
        </div>

        {/* List Images */}
        <div className="mb-4">
          <label htmlFor="List_Image" className="block text-gray-700 font-bold mb-2">Ảnh phụ (Chọn nhiều file)</label>
          <input
            type="file"
            id="List_Image"
            name="List_Image"
            ...
            multiple
          />
           {formData.List_Image && Array.isArray(formData.List_Image) && formData.List_Image.length > 0 && (
             <p className="text-gray-600 text-sm mt-1">Selected: {formData.List_Image.length} file(s)</p>
          )}
